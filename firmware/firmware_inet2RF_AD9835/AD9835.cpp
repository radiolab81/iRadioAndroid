...
#define SCLK_HIGH digitalWrite(SCLK,1)
#define SCLK_LOW digitalWrite(SCLK,0)
#define FSYNC_HIGH digitalWrite(FSYNC,1)
#define FSYNC_LOW digitalWrite(FSYNC,0)
#define SDATA_HIGH digitalWrite(SDATA,1)
#define SDATA_LOW digitalWrite(SDATA,0)
